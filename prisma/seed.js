      ...
      'Álgebra': [
        {
          ...
          correctAnswer: '4',
          incorrectAnswers: ['3', '5', '9', '8'],
          difficulty: 'easy',
        },
        {
          title: 'Qual é a solução da equação x² - 5x + 6 = 0?',
          correctAnswer: 'x = 2 ou x = 3',
          incorrectAnswers: ['x = 1 ou x = 6', 'x = -2 ou x = -3', 'x = 0 ou x = 5', 'x = 2 ou x = 6'],
          difficulty: 'medium',
        },
        {
          title: 'Qual o valor de log₂(32)?',
          correctAnswer: '5',
          incorrectAnswers: ['4', '6', '16', '3'],
          difficulty: 'medium',
        },
        {
          title: 'Se f(x) = 2x² - 3x + 1, qual o valor de f(2)?',
          correctAnswer: '3',
          incorrectAnswers: ['5', '7', '9', '11'],
          difficulty: 'hard',
        },
      ],
      'Geometria': [
      ...
      'Gramática': [
        {
          ...
          incorrectAnswers: ['cidadões', 'cidadães', 'cidadanos', 'cidadais'],
          difficulty: 'easy',
        },
        {
          title: 'Em "Os livros estão sobre a mesa", qual é o sujeito?',
          correctAnswer: 'Os livros',
          incorrectAnswers: ['a mesa', 'estão sobre', 'sobre a mesa', 'livros'],
          difficulty: 'easy',
        },
        {
          ...
          incorrectAnswers: [
            'útil, fácil, ágil',
            'lâmpada, pássaro, médico',
            'casa, mesa, livro',
            'árvore, pêssego, último',
          ],
          difficulty: 'medium',
        },
        {
      ...
      'Interpretação': [
        {
          ...
          incorrectAnswers: [
            ...
            'Celebrar uma vitória inesperada',
          ],
          difficulty: 'easy',
        },
        {
          ...
          incorrectAnswers: [
            ...
            'A introdução com dados estatísticos',
          ],
          difficulty: 'medium',
        },
        {
          ...
          incorrectAnswers: ['Metonímia', 'Hipérbole', 'Antítese', 'Prosopopeia'],
          difficulty: 'medium',
        },
        {
          title: '"Li Machado" no sentido de "li as obras de Machado" é exemplo de:',
          correctAnswer: 'Metonímia',
          incorrectAnswers: ['Metáfora', 'Eufemismo', 'Pleonasmo', 'Hipérbole'],
          difficulty: 'hard',
        },
      ],
      'Literatura': [
        {
          ...
          incorrectAnswers: ['José de Alencar', 'Graciliano Ramos', 'Jorge Amado', 'Lima Barreto'],
          difficulty: 'easy',
        },
        {
          ...
          incorrectAnswers: [
            ...
            '1850, com a obra poética de Álvares de Azevedo',
          ],
          difficulty: 'medium',
        },
        {
      ...
      'Brasil Colônia': [
        ...
        },
        {
          ...
          incorrectAnswers: [
            ...
            'A proibição do cultivo do café pela Coroa',
          ],
          difficulty: 'hard',
        },
      ],
      'Brasil República': [
        {
          ...
          correctAnswer: '1889',
          incorrectAnswers: ['1888', '1891', '1822', '1890'],
          difficulty: 'easy',
        },
        {
        ...
        },
        {
          ...
          incorrectAnswers: ['1920 a 1930', '1945 a 1964', '1964 a 1985', '1889 a 1930'],
          difficulty: 'medium',
        },
        {
          title: 'O golpe militar no Brasil ocorreu em:',
          correctAnswer: '1964',
          incorrectAnswers: ['1930', '1945', '1985', '1968'],
          difficulty: 'easy',
        },
      ],
      'História Geral': [
        {
          ...
          correctAnswer: '1789',
          incorrectAnswers: ['1776', '1799', '1815', '1804'],
          difficulty: 'easy',
        },
        {
        ...
        },
        {
          ...
          correctAnswer: '1945',
          incorrectAnswers: ['1918', '1939', '1948', '1955'],
          difficulty: 'easy',
        },
        {
    ...
    topics: {
      'Geografia do Brasil': [
        ...
        },
        {
          ...
          correctAnswer: '26',
          incorrectAnswers: ['25', '27', '24', '22'],
          difficulty: 'easy',
        },
        {
          title: 'Qual o maior bioma brasileiro em extensão?',
          correctAnswer: 'Amazônia',
          incorrectAnswers: ['Cerrado', 'Caatinga', 'Mata Atlântica', 'Pantanal'],
          difficulty: 'easy',
        },
        {
      ...
      'Geografia Mundial': [
        {
          ...
          incorrectAnswers: ['Atlântico', 'Índico', 'Ártico', 'Antártico'],
          difficulty: 'easy',
        },
        {
          title: 'Qual o país mais populoso do mundo (dados recentes)?',
          correctAnswer: 'Índia',
          incorrectAnswers: ['China', 'Estados Unidos', 'Indonésia', 'Paquistão'],
          difficulty: 'medium',
        },
        {
          title: 'A Cordilheira dos Andes está localizada em qual continente?',
          correctAnswer: 'América do Sul',
          incorrectAnswers: ['América do Norte', 'Ásia', 'Europa', 'África'],
          difficulty: 'easy',
        },
        {
      ...
      'Citologia': [
        {
          ...
          incorrectAnswers: ['Tecido', 'Órgão', 'Molécula', 'Átomo'],
          difficulty: 'easy',
        },
        {
        ...
        },
        {
          ...
          incorrectAnswers: [
            ...
            'Procariontes não realizam respiração celular',
          ],
          difficulty: 'medium',
        },
        {
          ...
          incorrectAnswers: ['Mitocôndrias', 'Ribossomos', 'Núcleo', 'Vacúolos'],
          difficulty: 'easy',
        },
      ],
      'Genética': [
        {
          ...
          incorrectAnswers: ['Charles Darwin', 'Louis Pasteur', 'James Watson', 'Jean-Baptiste Lamarck'],
          difficulty: 'easy',
        },
        {
          title: 'Qual a molécula que carrega a informação genética?',
          correctAnswer: 'DNA',
          incorrectAnswers: ['ATP', 'Glicose', 'Proteína', 'Lipídio'],
          difficulty: 'easy',
        },
        {
        ...
        },
        {
          ...
          incorrectAnswers: ['100% Aa', '3 AA : 1 aa', '1 AA : 1 aa', '2 AA : 1 Aa : 1 aa'],
          difficulty: 'hard',
        },
      ],
      'Ecologia': [
        {
          ...
          incorrectAnswers: ['Comunidade', 'Ecossistema', 'Bioma', 'Habitat'],
          difficulty: 'easy',
        },
        {
        ...
        },
        {
          ...
          incorrectAnswers: [
            ...
            'Ambas as espécies permanecem neutras',
          ],
          difficulty: 'medium',
        },
        {
          ...
          incorrectAnswers: [
            ...
            'Apenas respiração e decomposição',
          ],
          difficulty: 'hard',
        },
      ],
      ...
      'Química Orgânica': [
        {
          ...
          incorrectAnswers: ['Oxigênio', 'Nitrogênio', 'Hidrogênio', 'Enxofre'],
          difficulty: 'easy',
        },
        {
          title: 'A fórmula C₂H₆ corresponde a qual hidrocarboneto?',
          correctAnswer: 'Etano',
          incorrectAnswers: ['Metano', 'Propano', 'Eteno', 'Butano'],
          difficulty: 'medium',
        },
        {
          title: 'O grupo funcional —OH caracteriza:',
          correctAnswer: 'Álcool',
          incorrectAnswers: ['Ácido carboxílico', 'Éter', 'Aldeído', 'Cetona'],
          difficulty: 'medium',
        },
        {
          title: 'Qual composto é um exemplo de hidrocarboneto aromático?',
          correctAnswer: 'Benzeno',
          incorrectAnswers: ['Etano', 'Etanol', 'Acetileno', 'Propeno'],
          difficulty: 'hard',
        },
      ],
      'Físico-Química': [
        ...
        },
        {
          ...
          incorrectAnswers: [
            ...
            'Uma reação nuclear com liberação de radiação',
          ],
          difficulty: 'hard',
        },
      ],
      ...
      'Vocabulário': [
        {
          ...
          correctAnswer: 'book',
          incorrectAnswers: ['pen', 'table', 'chair', 'door'],
          difficulty: 'easy',
        },
        {
          title: 'Qual é a tradução de "yesterday"?',
          correctAnswer: 'Ontem',
          incorrectAnswers: ['Hoje', 'Amanhã', 'Depois', 'Nunca'],
          difficulty: 'easy',
        },
        {
          title: 'Complete: "I _____ coffee every morning."',
          correctAnswer: 'drink',
          incorrectAnswers: ['drinks', 'drinking', 'drank', 'drunk'],
          difficulty: 'medium',
        },
        {
          title: '"Break a leg" é uma expressão que significa:',
          correctAnswer: 'Boa sorte',
          incorrectAnswers: ['Quebrar uma perna', 'Ter cuidado', 'Ficar em casa', 'Desistir de algo'],
          difficulty: 'hard',
        },
      ],
      'Gramática': [
        {
          ...
          correctAnswer: 'went',
          incorrectAnswers: ['goed', 'gone', 'going', 'goes'],
          difficulty: 'easy',
        },
        {
          title: 'Complete: "She has _____ to Paris three times."',
          correctAnswer: 'been',
          incorrectAnswers: ['be', 'being', 'was', 'is'],
          difficulty: 'medium',
        },
        {
